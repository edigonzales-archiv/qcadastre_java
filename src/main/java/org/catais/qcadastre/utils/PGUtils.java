...
public class PGUtils 
{
	...
	public static StringBuffer getSqlCreateStatements(ch.interlis.ili2c.metamodel.TransferDescription td, String schema, String dbadmin, String dbuser, String epsg, boolean enumerationText) throws IOException 
	{
    				...
    				if (tObj instanceof Topic) {
    					...
    					while (iter.hasNext()) {
    						...
    						if (obj instanceof Viewable) {
    							...
    							// Die NICHT-Geometrie Inidizes schreiben
